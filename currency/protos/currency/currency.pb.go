...
// Define the base and destination currency code for the rate, and they should exist in the Currencies list
type RateRequest struct {
	Base        Currencies `protobuf:"varint,1,opt,name=Base,enum=Currencies" json:"Base,omitempty"`
	Destination Currencies `protobuf:"varint,2,opt,name=Destination,enum=Currencies" json:"Destination,omitempty"`
}
